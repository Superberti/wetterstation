...
// Standardkonfigurationen für verschiedene Boards:
...
public:
  ...
  LoRa_PinConfiguration mPinConfig;
  void Reset();
  void CloseSPI();
  ...
  LoRaBase(const LoRa_PinConfiguration & aPinConfig);
  virtual ~LoRaBase();
};
...
public:
  ...
  SX1278_LoRa(const LoRa_PinConfiguration & aPinConfig);
  //~SX1278_LoRa();
};
...
public:
  ...
  SX1262_LoRa(const LoRa_PinConfiguration & aPinConfig);
};
#endif
